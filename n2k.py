...
- python3 export_kitti.py nuscenes_gt_to_kitti --nusc_kitti_dir /OpenPCDet/datasets/v1.0-trainval
...
class KittiConverter:
    def __init__(self,
                 nusc_kitti_dir: str = '/OpenPCDet/dataset/v1.0-trainval',
                 cam_name: str = 'CAM_FRONT',
                 lidar_name: str = 'LIDAR_TOP',
                 image_count: int = 10,
                 nusc_version: str = 'v1.0-trainval',
                 split: str = 'train_detect',
        ...
        self.nusc = NuScenes(version=nusc_version, dataroot='/OpenPCDet/datasets/v1.0-trainval')
